    ...
    <Container>
      <div className=" pt-10 pb-8 ">
        ...
        <section className="mb-8">
          ...
          <p>
            1.2. <strong>Informações de Reserva:</strong> Ao efetuar uma
            reserva, coletamos informações sobre a data selecionada, tipo de
            mesa escolhida (individual ou para grupo) e outras informações
            relacionadas à reserva.
          </p>
          <p>
            1.3. <strong> Informações de Perfil:</strong> Os usuários têm a
            opção de criar um perfil onde podem visualizar o histórico de
            reservas, editar preferências e informações pessoais.
          </p>
          <p>
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            informações coletadas para oferecer e gerenciar os serviços do
            Refúgio Universitário, incluindo reservas de mesas e notificações
            por e-mail.
          </p>
          <p>
            2.2. <strong>Personalização:</strong> Utilizamos as informações
            coletadas para oferecer e gerenciar os serviços do Refúgio
            Universitário, incluindo reservas de mesas e notificações por
            e-mail.
          </p>
          <p>
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            para facilitar reservas e melhorar nossos serviços.
          </p>
          <p>
