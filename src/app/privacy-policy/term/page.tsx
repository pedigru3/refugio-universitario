    ...
    <div className="max-w-[600px] mx-auto mt-8 px-10">
      ...
      <section className="mb-8">
        ...
        <p>
          ...
          Universitário, você concorda em obedecer a estes Termos de Serviço. Se
          você não concordar com algum dos termos aqui presentes, por favor, não
      ...
      <section className="mb-8">
        ...
        <p>
          3.1. <strong>Uso adequado:</strong> Ao utilizar nossos serviços, você
          concorda em não violar leis aplicáveis e regulamentos. Você é
          responsável por todas as atividades associadas à sua conta.
        </p>
        <p>
          3.2. <strong>Informações Pessoais: </strong> É de sua responsabilidade
          fornecer informações precisas e atualizadas. O Refúgio Universitário
          não se responsabiliza por informações incorretas ou desatualizadas
      ...
      <section className="mb-8">
        ...
        <p>
          O Refúgio Universitário valoriza a privacidade dos usuários. Para mais
          informações sobre como tratamos seus dados, consulte nossa{' '}
          <Link className="underline" href={'/privacy-policy'}>
      ...
      <section className="mb-8">
        ...
        <p>
          Em nenhuma circunstância o Refúgio Universitário, seus proprietários,
          funcionários ou afiliados serão responsáveis por quaisquer danos
          diretos, indiretos, incidentais, especiais ou consequenciais
          decorrentes do uso ou da incapacidade de usar nossos serviços.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p>
          ...
          Recomendamos que os usuários revejam regularmente os termos para estar
          cientes de quaisquer alterações.
        </p>
      </section>
